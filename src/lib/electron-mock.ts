...
const mockAPI: ElectronAPI = {
  ...
  getInvoices: async () => [
    {
      ...
      month: '2026-05', approval_files: null, statement_files: null, master_count: 0, pdf_mapped: true,
      printed_at: '2026-05-30 14:20:00',
    },
    {
      ...
      month: '2026-05', approval_files: null, statement_files: null, master_count: 0, pdf_mapped: false,
      printed_at: null,
    },
  ],
  ...
  exportDashboardPdf: async (_html, defaultName) => ({ ok: true, file_path: `~/Desktop/${defaultName}` }),
